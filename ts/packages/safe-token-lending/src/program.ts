...
import { SafeTokenLendingCoder } from "./coder";

export const SAFE_TOKEN_LENDING_PROGRAM_ID = new PublicKey(
...
): Program<SafeTokenLending> {
  return new Program<SafeTokenLending>(
    IDL,
    params?.programId ?? SAFE_TOKEN_LENDING_PROGRAM_ID,
    params?.provider,
    new SafeTokenLendingCoder(IDL)
  );
}

type SafeTokenLending = {
  version: "0.2.0";
  name: "safe_token_lending";
  instructions: [
    {
