...
type SplGovernance = {
  ...
  errors: [
    ...
    {
      code: 543;
      name: "SafeTokenAccountWithInvalidOwner";
      msg: "Invalid Token account owner";
    },
    {
      code: 544;
      name: "SafeTokenMintWithInvalidOwner";
      msg: "Invalid Mint account owner";
    },
    {
      code: 545;
      name: "SafeTokenAccountNotInitialized";
      msg: "Token Account is not initialized";
    },
    {
      code: 546;
      name: "SafeTokenAccountDoesNotExist";
      msg: "Token Account doesn't exist";
    },
    {
      code: 547;
      name: "SafeTokenInvalidTokenAccountData";
      msg: "Token account data is invalid";
    },
    {
      code: 548;
      name: "SafeTokenInvalidMintAccountData";
      msg: "Token mint account data is invalid";
    },
    {
      code: 549;
      name: "SafeTokenMintNotInitialized";
      msg: "Token Mint account is not initialized";
    },
    {
      code: 550;
      name: "SafeTokenMintDoesNotExist";
