...
DEX_PID="safhmRNhffR7skWseXnptkaCm8XNTCZvZu9UCqMDnMD"
...
main () {
		...
		safecoin-test-validator \
				--bpf-program safhmRNhffR7skWseXnptkaCm8XNTCZvZu9UCqMDnMD ./deps/openbook-dex/dex/target/deploy/serum_dex.so \
