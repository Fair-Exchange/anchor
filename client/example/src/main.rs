use safe_anchor_client::safecoin_sdk::commitment_config::CommitmentConfig;
use safe_anchor_client::safecoin_sdk::pubkey::Pubkey;
use safe_anchor_client::safecoin_sdk::signature::read_keypair_file;
use safe_anchor_client::safecoin_sdk::signature::{Keypair, Signer};
use safe_anchor_client::safecoin_sdk::system_instruction;
use safe_anchor_client::{Client, Cluster, EventContext};
use anyhow::Result;
...
fn main() -> Result<()> {
    ...
    let url = Cluster::Custom(
        "http://localhost:8328".to_string(),
        "ws://127.0.0.1:8329".to_string(),
    );
...
fn events<C: Deref<Target = impl Signer> + Clone>(client: &Client<C>, pid: Pubkey) -> Result<()> {
    ...
    // TODO: remove once https://github.com/fair-exchange/safecoin/issues/16102
